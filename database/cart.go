...
var (
	...
	ErrCantGetItem        = errors.New("was unable to get the item from this cart")
...
func InstantBuyer(ctx context.Context, prodCollection, userColletion *mongo.Collection, productID primitive.ObjectID, UserID string)error {
	id, err := primitive.ObjectIDFromHex(UserID)
	...
	order_detail.Orderered_At = time.Now()
